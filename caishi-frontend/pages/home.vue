...
<style lang="scss" src="../assets/scss/home/index.scss" scoped></style>
...
export default {
  ...
  computed: {
    ...
    lottoList() {
      return this.lottoTypes.map((lotto) => {
        return Object.keys(lotto.infos)
      })
    }
  },
  mounted() {
    function QieHuan() {
      ...
      $(".gamesSboxT li").click(function(){
      	$(".gamesFbox .gameCon").eq($(this).index()).addClass('active').siblings().removeClass('active');
      })
    }
    QieHuan()
