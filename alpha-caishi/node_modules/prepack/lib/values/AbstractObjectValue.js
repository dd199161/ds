...
var AbstractObjectValue = function (_AbstractValue) {
  ...
  _createClass(AbstractObjectValue, [{
    ...
    value: function $Get(P, Receiver) {
      ...
      if (P instanceof _index.StringValue) P = P.value;
      if (this.values.isTop()) {
        var generateAbstractGet = function generateAbstractGet() {
          var type = _index.Value;
          if (P === "length" && _index.Value.isTypeCompatibleWith(_this2.getType(), _index.ArrayValue)) type = _NumberValue2.default;
          var object = _this2.kind === "sentinel ToObject" ? _this2.args[0] : _this2;
          return _index.AbstractValue.createTemporalFromBuildFunction(_this2.$Realm, type, [object], function (_ref) {
        ...
        if (this.isSimpleObject() && this.isIntrinsic()) {
          ...
          _singletons.Leak.leakValue(this.$Realm, this);
