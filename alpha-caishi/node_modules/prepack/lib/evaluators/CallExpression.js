...
function EvaluateCall(ref, func, ast, strictCode, env, realm) {
  function generateRuntimeCall() {
    ...
    return _index2.AbstractValue.createTemporalFromBuildFunction(realm, _index2.Value, args, function (nodes) {
      var callFunc = void 0;
      var argStart = 1;
  ...
  if (func instanceof _index2.AbstractValue) {
    ...
    if (realm.isInPureScope()) {
      ...
      return realm.evaluateWithPossibleThrowCompletion(generateRuntimeCall, _index.TypesDomain.topVal, _index.ValuesDomain.topVal);
    }
  ...
  if (ref instanceof _environment.Reference && !_singletons.Environment.IsPropertyReference(realm, ref) && _singletons.Environment.GetReferencedName(realm, ref) === "eval") {
    ...
    if ((0, _index3.SameValue)(realm, func, realm.intrinsics.eval)) {
      ...
      var argList = (0, _index3.ArgumentListEvaluation)(realm, strictCode, env, ast.arguments);
  ...
  var tailCall = (0, _index3.IsInTailPosition)(realm, thisCall);
