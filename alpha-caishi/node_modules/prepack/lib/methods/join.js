  ...
  _createClass(JoinImplementation, [{
    ...
    e) {
      ...
      if (pnc.consequent instanceof _completions.AbruptCompletion) {
        ...
        var composedEffects = realm.composeEffects(pnc.alternateEffects, alternate_effects);
        ...
        var _composedEffects = realm.composeEffects(pnc.consequentEffects, consequent_effects);
        (0, _invariant2.default)(pnc.alternate instanceof _completions.AbruptCompletion);
        return this.joinEffects(realm, pnc.joinCondition, _composedEffects, pnc.alternateEffects);
      }
    }
  }, {
    ...
    key: "joinPossiblyNormalCompletions",
    value: function joinPossiblyNormalCompletions(realm, joinCondition, c, a) {
      var rJoinCondition = void 0;
      var cp = void 0;
      var ap = void 0;
      if (c.consequent instanceof _completions.AbruptCompletion) {
        if (a.consequent instanceof _completions.AbruptCompletion) {
          ...
          var notA = _index2.AbstractValue.createFromUnaryOp(realm, "!", a.joinCondition);
        ...
        var notC = _index2.AbstractValue.createFromUnaryOp(realm, "!", c.joinCondition);
        if (a.consequent instanceof _completions.AbruptCompletion) {
          ...
          var _notA = _index2.AbstractValue.createFromUnaryOp(realm, "!", a.joinCondition);
          rJoinCondition = _index2.AbstractValue.createFromLogicalOp(realm, "&&", notC, _notA);
      ...
      var rce = this.joinEffects(realm, joinCondition, ce1, ce2);
      var rae = this.joinEffects(realm, joinCondition, ae1, ae2);
      var rc = rce[0];
      ...
      var rv = ra instanceof _completions.PossiblyNormalCompletion ? ra.value : ra;
    ...
    value: function unbundleReturnCompletion(realm, c) {
      ...
      c.alternateEffects[1] = new _generator.Generator(realm);
      c.consequentEffects[1] = new _generator.Generator(realm);
