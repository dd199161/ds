...
exports.default = function (realm) {
  ...
  func.defineNativeMethod("from", 1, function (context, _ref) {
    ...
    var arrayLike = _singletons.To.ToObjectPartial(realm, source);

    // 10. Let len be ? ToLength(? Get(arrayLike, "length")).
    var len = _singletons.To.ToLength(realm, (0, _get.Get)(realm, arrayLike, "length"));
...
function build(realm, type) {
  var func = new _index.NativeFunctionValue(realm, type + "Array", type + "Array", 3, function (context, args, argCount, NewTarget) {
    if (argCount === 0) {
      ...
      var elementLength = _singletons.To.ToIndexPartial(realm, length);
      ...
      if (!(usingIterator instanceof _index.UndefinedValue)) {
        ...
        while (_k2 < _len2) {
          // i. Let Pk be ! ToString(k).
          var Pk = new _index.StringValue(realm, _singletons.To.ToString(realm, new _index.NumberValue(realm, _k2)));
      ...
      while (k < len) {
        // a. Let Pk be ! ToString(k).
        var _Pk2 = new _index.StringValue(realm, _singletons.To.ToString(realm, new _index.NumberValue(realm, k)));
      ...
      if (!_length || _length instanceof _index.UndefinedValue) {
        ...
        var newLength = _singletons.To.ToIndexPartial(realm, _length);
