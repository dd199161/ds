...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("every", 1, function (context, _ref3) {
    ...
    while (k < len) {
      ...
      if (kPresent) {
        ...
        var testResult = _singletons.To.ToBooleanPartial(realm, (0, _call.Call)(realm, callbackfn, T, [kValue, new _index.NumberValue(realm, k), O]));
  ...
  obj.defineNativeMethod("filter", 1, function (context, _ref7) {
    ...
    while (k < len) {
      ...
      var selected = _singletons.To.ToBooleanPartial(realm, (0, _call.Call)(realm, callbackfn, T, [kValue, new _index.NumberValue(realm, k), O]));
  ...
  obj.defineNativeMethod("find", 1, function (context, _ref9) {
    ...
    while (k < len) {
      ...
      var testResult = _singletons.To.ToBooleanPartial(realm, (0, _call.Call)(realm, predicate, T, [kValue, new _index.NumberValue(realm, k), O]));
  ...
  obj.defineNativeMethod("includes", 1, function (context, _ref15) {
    ...
    while (k < len) {
      ...
      var elementK = (0, _get.Get)(realm, O, _singletons.To.ToString(realm, new _index.NumberValue(realm, k)));
  ...
  obj.defineNativeMethod("set", 1, function (context, _ref29) {
    ...
    if (!overloaded.$TypedArrayName) {
      ...
      var targetOffset = _singletons.To.ToInteger(realm, offset || realm.intrinsics.undefined);
      ...
      var src = _singletons.To.ToObjectPartial(realm, array);

      // 16. Let srcLength be ? ToLength(? Get(src, "length")).
      var srcLength = _singletons.To.ToLength(realm, (0, _get.Get)(realm, src, "length"));
      ...
      while (targetByteIndex < limit) {
        ...
        var kNumber = _singletons.To.ToNumber(realm, (0, _get.Get)(realm, src, Pk));
      ...
      // 6. Let targetOffset be ? ToInteger(offset).
      var _targetOffset = _singletons.To.ToInteger(realm, offset || realm.intrinsics.undefined);
  ...
  obj.defineNativeMethod("subarray", 2, function (context, _ref37) {
    ...
    var relativeBegin = _singletons.To.ToInteger(realm, begin);
    ...
    var relativeEnd = !end || end instanceof _index.UndefinedValue ? srcLength : _singletons.To.ToInteger(realm, end.throwIfNotConcrete());
