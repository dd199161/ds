...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("concat", 1, function (context, args, argCount) {
    ...
    var A = _singletons.Create.ArraySpeciesCreate(realm, O, 0);
    ...
    while (items.length) {
      ...
      if (spreadable) {
        ...
        var len = _singletons.To.ToLength(realm, (0, _index2.Get)(realm, E, "length"));
  ...
  // ECMA262 22.1.3.3
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("copyWithin", 2, function (context, _ref) {
    ...
    var len = _singletons.To.ToLength(realm, (0, _index2.Get)(realm, O, "length"));

    // 3. Let relativeTarget be ? ToInteger(target).
    var relativeTarget = _singletons.To.ToInteger(realm, target);
    ...
    while (count > 0) {
      ...
      var fromKey = _singletons.To.ToString(realm, new _index.NumberValue(realm, from));

      // b. Let toKey be ! ToString(to).
      var toKey = _singletons.To.ToString(realm, new _index.NumberValue(realm, to));
  ...
  obj.defineNativeMethod("every", 1, function (context, _ref3) {
    ...
    while (k < len) {
      ...
      if (kPresent) {
        ...
        var testResult = _singletons.To.ToBooleanPartial(realm, (0, _index2.Call)(realm, callbackfn, T, [kValue, new _index.NumberValue(realm, k), O]));
  ...
  obj.defineNativeMethod("fill", 1, function (context, _ref5) {
    ...
    var relativeStart = _singletons.To.ToInteger(realm, start || realm.intrinsics.undefined);
  ...
  obj.defineNativeMethod("filter", 1, function (context, _ref7) {
    ...
    while (k < len) {
      ...
      if (kPresent) {
        ...
        var selected = _singletons.To.ToBooleanPartial(realm, (0, _index2.Call)(realm, callbackfn, T, [kValue, new _index.NumberValue(realm, k), O]));
  ...
  obj.defineNativeMethod("find", 1, function (context, _ref9) {
    ...
    while (k < len) {
      ...
      var testResult = _singletons.To.ToBooleanPartial(realm, (0, _index2.Call)(realm, predicate, T, [kValue, new _index.NumberValue(realm, k), O]));
  ...
  // ECMA262 22.1.3.11
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("includes", 1, function (context, _ref15) {
    ...
    var n = _singletons.To.ToInteger(realm, fromIndex || realm.intrinsics.undefined);
    ...
    while (k < len) {
      ...
      var elementK = (0, _index2.Get)(realm, O, _singletons.To.ToString(realm, new _index.NumberValue(realm, k)));
  ...
  obj.defineNativeMethod("indexOf", 1, function (context, _ref17) {
    ...
    // 4. Let n be ? ToInteger(fromIndex). (If fromIndex is undefined, this step produces the value 0.)
    var n = fromIndex ? _singletons.To.ToInteger(realm, fromIndex) : 0;
  ...
  obj.defineNativeMethod("join", 1, function (context, _ref19) {
    ...
    var sep = _singletons.To.ToStringPartial(realm, separator);
  ...
  obj.defineNativeMethod("lastIndexOf", 1, function (context, _ref21) {
    ...
    var n = fromIndex ? _singletons.To.ToInteger(realm, fromIndex) : len - 1;
  ...
  obj.defineNativeMethod("map", 1, function (context, _ref23) {
    ...
    var A = _singletons.Create.ArraySpeciesCreate(realm, O, len);
  ...
  obj.defineNativeMethod("push", 1, function (context, args, argCount) {
    ...
    // 2. Let len be ? ToLength(? Get(O, "length")).
    var len = _singletons.To.ToLength(realm, (0, _index2.Get)(realm, O, new _index.StringValue(realm, "length")));
  ...
  obj.defineNativeMethod("slice", 2, function (context, _ref29) {
    ...
    var A = _singletons.Create.ArraySpeciesCreate(realm, O, count);
  ...
  obj.defineNativeMethod("sort", 1, function (context, _ref33) {
    ...
    var SortCompare = function SortCompare(x, y) {
      ...
      if (!comparefn.mightBeUndefined()) {
        ...
        var v = _singletons.To.ToNumber(realm, (0, _index2.Call)(realm, comparefn, new _index.UndefinedValue(realm), [x, y]));
      ...
      var xString = new _index.StringValue(realm, _singletons.To.ToString(realm, x));
      // 6. Let yString be ? ToString(y).
      var yString = new _index.StringValue(realm, _singletons.To.ToString(realm, y));
    ...
    var comparefn_ = function comparefn_(x, y) {
      ...
      var numb = _singletons.To.ToNumber(realm, result_);
      return numb;
    };
  ...
  obj.defineNativeMethod("splice", 2, function (context, _ref35, argLength) {
    ...
    if (argLength === 0) {
      ...
      var dc = _singletons.To.ToInteger(realm, deleteCount);
    ...
    var A = _singletons.Create.ArraySpeciesCreate(realm, O, actualDeleteCount);
  ...
  obj.defineNativeMethod("toLocaleString", 0, function (context) {
    ...
    var array = _singletons.To.ToObject(realm, context.throwIfNotConcrete());

    // 2. Let len be ? ToLength(? Get(array, "length")).
    var len = _singletons.To.ToLength(realm, (0, _index2.Get)(realm, array, "length"));
  ...
  // ECMA262 22.1.3.32
  {
    ...
    var unscopableList = _singletons.Create.ObjectCreate(realm, realm.intrinsics.null);
