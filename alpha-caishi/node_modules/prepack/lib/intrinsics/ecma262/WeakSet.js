...
exports.default = function (realm) {
  // ECMA262 23.4.1.1
  var func = new _index.NativeFunctionValue(realm, "WeakSet", "WeakSet", 0, function (args, _ref, argCount, NewTarget) {
    ...
    var set = _singletons.Create.OrdinaryCreateFromConstructor(realm, NewTarget, "WeakSetPrototype", {
