...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("exec", 1, function (context, _ref) {
    ...
    var S = _singletons.To.ToStringPartial(realm, string);
  ...
  obj.defineNativeGetter("flags", function (context) {
    ...
    var global = _singletons.To.ToBooleanPartial(realm, (0, _get.Get)(realm, R, "global"));

    // 5. If global is true, append "g" as the last code unit of result.
    if (global) result += "g";

    // 6. Let ignoreCase be ToBoolean(? Get(R, "ignoreCase")).
    var ignoreCase = _singletons.To.ToBooleanPartial(realm, (0, _get.Get)(realm, R, "ignoreCase"));

    // 7. If ignoreCase is true, append "i" as the last code unit of result.
    if (ignoreCase) result += "i";

    // 8. Let multiline be ToBoolean(? Get(R, "multiline")).
    var multiline = _singletons.To.ToBooleanPartial(realm, (0, _get.Get)(realm, R, "multiline"));
    ...
    var unicode = _singletons.To.ToBooleanPartial(realm, (0, _get.Get)(realm, R, "unicode"));

    // 11. If unicode is true, append "u" as the last code unit of result.
    if (unicode) result += "u";

    // 12. Let sticky be ToBoolean(? Get(R, "sticky")).
    var sticky = _singletons.To.ToBooleanPartial(realm, (0, _get.Get)(realm, R, "sticky"));
  ...
  obj.defineNativeMethod(realm.intrinsics.SymbolMatch, 1, function (context, _ref3) {
    ...
    var global = _singletons.To.ToBooleanPartial(realm, (0, _get.Get)(realm, rx, "global"));
    ...
    if (global === false) {
      ...
      var fullUnicode = _singletons.To.ToBooleanPartial(realm, (0, _get.Get)(realm, rx, "unicode"));
      ...
      while (true) {
        ...
        if (result instanceof _index.NullValue) {
          ...
          var matchStr = _singletons.To.ToStringPartial(realm, (0, _get.Get)(realm, result, "0"));

          // 2. Let status be CreateDataProperty(A, ! ToString(n), matchStr).
          var status = _singletons.Create.CreateDataProperty(realm, A, _singletons.To.ToString(realm, new _index.NumberValue(realm, n)), new _index.StringValue(realm, matchStr));
          ...
          if (matchStr === "") {
            ...
            var thisIndex = _singletons.To.ToLength(realm, (0, _get.Get)(realm, rx, "lastIndex"));
  ...
  obj.defineNativeMethod(realm.intrinsics.SymbolReplace, 2, function (context, _ref5) {
    ...
    try {
      for (var _iterator = results[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var nCaptures = _singletons.To.ToLength(realm, (0, _get.Get)(realm, _result, "length"));

        // b. Let nCaptures be max(nCaptures - 1, 0).
        nCaptures = Math.max(nCaptures - 1, 0);

        // c. Let matched be ? ToString(? Get(result, "0")).
        var matched = _singletons.To.ToStringPartial(realm, (0, _get.Get)(realm, _result, "0"));

        // d. Let matchLength be the number of code units in matched.
        var matchLength = matched.length;

        // e. Let position be ? ToInteger(? Get(result, "index")).
        var position = _singletons.To.ToInteger(realm, (0, _get.Get)(realm, _result, "index"));
        ...
        while (n <= nCaptures) {
          ...
          var capN = (0, _get.Get)(realm, _result, _singletons.To.ToString(realm, new _index.NumberValue(realm, n)));
  ...
  obj.defineNativeMethod(realm.intrinsics.SymbolSplit, 2, function (context, _ref9) {
    ...
    var flags = _singletons.To.ToStringPartial(realm, (0, _get.Get)(realm, rx, "flags"));
    ...
    var lim = limit instanceof _index.UndefinedValue ? Math.pow(2, 32) - 1 : _singletons.To.ToUint32(realm, limit.throwIfNotConcrete());
    ...
    while (q < size) {
      ...
      if (_z instanceof _index.NullValue) {
        ...
        var e = _singletons.To.ToLength(realm, (0, _get.Get)(realm, splitter, "lastIndex"));
        ...
        if (e === p) {
          ...
          _singletons.Create.CreateDataProperty(realm, A, _singletons.To.ToString(realm, new _index.NumberValue(realm, lengthA)), new _index.StringValue(realm, _T));
          ...
          var numberOfCaptures = _singletons.To.ToLength(realm, (0, _get.Get)(realm, _z, "length"));
          ...
          while (i <= numberOfCaptures) {
            ...
            var nextCapture = (0, _get.Get)(realm, _z, _singletons.To.ToString(realm, new _index.NumberValue(realm, i)));
  ...
  obj.defineNativeMethod("test", 1, function (context, _ref11) {
    ...
    var string = _singletons.To.ToStringPartial(realm, S);
  ...
  obj.defineNativeMethod("toString", 0, function (context) {
    ...
    var pattern = _singletons.To.ToStringPartial(realm, (0, _get.Get)(realm, R, "source"));

    // 4. Let flags be ? ToString(? Get(R, "flags")).
    var flags = _singletons.To.ToStringPartial(realm, (0, _get.Get)(realm, R, "flags"));
