...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("charAt", 1, function (context, _ref) {
    ...
    var S = _singletons.To.ToString(realm, O.throwIfNotConcrete());

    // 3. Let position be ? ToInteger(pos).
    var position = _singletons.To.ToInteger(realm, pos);
  ...
  // ECMA262 21.1.3.3
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("codePointAt", 1, function (context, _ref5) {
  ...
  obj.defineNativeMethod("concat", 1, function (context, args, argCount) {
    ...
    while (args.length) {
      ...
      var nextString = _singletons.To.ToStringPartial(realm, next);
  ...
  // ECMA262 21.1.3.6
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("endsWith", 1, function (context, _ref7) {
    ...
    var searchStr = _singletons.To.ToStringPartial(realm, searchString);
  ...
  // ECMA262 21.1.3.7
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("includes", 1, function (context, _ref9) {
    ...
    var pos = _singletons.To.ToInteger(realm, position || realm.intrinsics.undefined);
  ...
  obj.defineNativeMethod("indexOf", 1, function (context, _ref11) {
    ...
    var pos = position ? _singletons.To.ToInteger(realm, position) : 0;
  ...
  obj.defineNativeMethod("lastIndexOf", 1, function (context, _ref13) {
    ...
    var numPos = _singletons.To.ToNumber(realm, position || realm.intrinsics.undefined);
  ...
  obj.defineNativeMethod("localeCompare", 1, function (context, _ref15) {
    ...
    var That = _singletons.To.ToStringPartial(realm, that);
  ...
  obj.defineNativeMethod("match", 1, function (context, _ref17) {
    ...
    var S = new _index.StringValue(realm, _singletons.To.ToStringPartial(realm, O));
  ...
  // ECMA262 21.1.3.12
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("normalize", 0, function (context, _ref19) {
    ...
    var f = _singletons.To.ToStringPartial(realm, form);
  ...
  // ECMA262 21.1.3.13
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("padEnd", 1, function (context, _ref21) {
    ...
    var intMaxLength = _singletons.To.ToLength(realm, maxLength);
  ...
  // ECMA262 21.1.3.14
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("padStart", 1, function (context, _ref23) {
  ...
  // ECMA262 21.1.3.13
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("repeat", 1, function (context, _ref25) {
    ...
    var n = _singletons.To.ToInteger(realm, count);
  ...
  obj.defineNativeMethod("replace", 2, function (context, _ref27) {
    ...
    var string = _singletons.To.ToString(realm, O.throwIfNotConcrete());

    // 4. Let searchString be ? ToString(searchValue).
    var searchString = _singletons.To.ToStringPartial(realm, searchValue);
  ...
  obj.defineNativeMethod("search", 1, function (context, _ref29) {
    ...
    // 3. Let string be ? ToString(O).
    var string = _singletons.To.ToStringPartial(realm, O);
  ...
  obj.defineNativeMethod("slice", 2, function (context, _ref31) {
    ...
    var intStart = _singletons.To.ToInteger(realm, start);

    // 5. If end is undefined, let intEnd be len; else let intEnd be ? ToInteger(end).
    var intEnd = !end || end instanceof _index.UndefinedValue ? len : _singletons.To.ToInteger(realm, end.throwIfNotConcrete());
  ...
  obj.defineNativeMethod("split", 2, function (context, _ref33) {
    ...
    var lim = !limit || limit instanceof _index.UndefinedValue ? Math.pow(2, 32) - 1 : _singletons.To.ToUint32(realm, limit.throwIfNotConcrete());
    ...
    var R = _singletons.To.ToStringPartial(realm, separator);
    ...
    while (q !== s) {
      ...
      if (e === false) {
        ...
        if (e === p) {
          ...
          _singletons.Create.CreateDataProperty(realm, A, new _index.StringValue(realm, lengthA + ""), new _index.StringValue(realm, _T));
  ...
  // ECMA262 21.1.3.18
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) obj.defineNativeMethod("startsWith", 1, function (context, _ref35) {
  ...
  obj.defineNativeMethod("substr", 2, function (context, _ref43) {
    ...
    // 2. Let S be ToString(O).
    var S = _singletons.To.ToStringPartial(realm, O);
