...
exports.default = function (realm) {
  var func = new _index.NativeFunctionValue(realm, "WeakMap", "WeakMap", 0, function (args, _ref, argCount, NewTarget) {
    ...
    var map = _singletons.Create.OrdinaryCreateFromConstructor(realm, NewTarget, "WeakMapPrototype", {
    ...
    while (true) {
      ...
      var nextItem = (0, _index2.IteratorValue)(realm, next).throwIfNotConcrete();
