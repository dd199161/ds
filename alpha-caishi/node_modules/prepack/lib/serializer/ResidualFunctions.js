...
var ResidualFunctions = exports.ResidualFunctions = function () {
  ...
  _createClass(ResidualFunctions, [{
    ...
    value: function spliceFunctions(rewrittenAdditionalFunctions) {
      ...
      var defineFunction = function defineFunction(instance, funcId, funcOrClassNode) {
      ...
      try {
        for (var _iterator5 = this.additionalFunctionValueInfos.entries()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          ...
          var funcOrClassNode = void 0;

          if (this.residualClassMethodInstances.has(_funcValue)) {
            var classMethodInstance = this.residualClassMethodInstances.get(_funcValue);
            (0, _invariant2.default)(classMethodInstance);
            var methodType = classMethodInstance.methodType,
                classMethodKeyNode = classMethodInstance.classMethodKeyNode,
                classSuperNode = classMethodInstance.classSuperNode,
                classMethodComputed = classMethodInstance.classMethodComputed,
                classPrototype = classMethodInstance.classPrototype,
                classMethodIsStatic = classMethodInstance.classMethodIsStatic;


            var isConstructor = methodType === "constructor";
            ...
            var classMethod = t.classMethod(methodType, classMethodKeyNode, funcParams, functionBody, classMethodComputed, classMethodIsStatic);
        ...
        var naiveProcessInstances = function naiveProcessInstances(instancesToSplice) {
          ...
          try {
            for (var _iterator13 = instancesToSplice[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
              ...
              var _funcOrClassNode = void 0;

              if (_this.residualClassMethodInstances.has(_functionValue)) {
                var _classMethodInstance = _this.residualClassMethodInstances.get(_functionValue);
                (0, _invariant2.default)(_classMethodInstance);
                var _classSuperNode = _classMethodInstance.classSuperNode,
                    _classMethodKeyNode = _classMethodInstance.classMethodKeyNode,
                    _methodType = _classMethodInstance.methodType,
                    _classMethodComputed = _classMethodInstance.classMethodComputed,
                    _classPrototype = _classMethodInstance.classPrototype,
                    _classMethodIsStatic = _classMethodInstance.classMethodIsStatic;


                var _isConstructor = _methodType === "constructor";
                (0, _invariant2.default)(_classPrototype instanceof _index.ObjectValue);
                (0, _invariant2.default)(_classMethodKeyNode);
                (0, _invariant2.default)(t.isExpression(_classMethodKeyNode) || t.isIdentifier(_classMethodKeyNode));
                // we use the classPrototype as the key to get the class expression ast node
                _funcOrClassNode = _this._getOrCreateClassNode(_classPrototype);
                ...
                var hasEmptyConstructor = !!_functionValue.$HasEmptyConstructor;
                if (!_isConstructor || _isConstructor && !hasEmptyConstructor) {
                  var methodParams = params.slice();
                  var methodBody = t.cloneDeep(_funcBody);
                  // create the class method AST
                  var _classMethod = t.classMethod(_methodType, _classMethodKeyNode, methodParams, methodBody, _classMethodComputed, _classMethodIsStatic);
                  // traverse and replace refs in the class method
                  (0, _babelTraverse2.default)(t.file(t.program([t.expressionStatement(t.classExpression(null, null, t.classBody([_classMethod]), []))])), _visitors.ClosureRefReplacer, null, {
                    residualFunctionBindings: residualFunctionBindings,
                    modified: modified,
                    requireReturns: _this.requireReturns,
                    requireStatistics: requireStatistics,
                    isRequire: _this.modules.getIsRequire(methodParams, [_functionValue]),
                    factoryFunctionInfos: factoryFunctionInfos
                  });
                  // add the class method to the class expression node body
                  if (_isConstructor) {
                    _funcOrClassNode.body.body.unshift(_classMethod);
                  } else {
                    _funcOrClassNode.body.body.push(_classMethod);
                  }
                }
                // we only return the funcOrClassNode if this is the constructor
                if (!_isConstructor) {
                ...
                // handle the class super
                if (_classSuperNode !== undefined) {
                  _funcOrClassNode.superClass = _classSuperNode;
                }
              } else {
                var _funcParams = params.slice();
                _funcOrClassNode = t.functionExpression(null, _funcParams, t.cloneDeep(_funcBody));
                ...
                _funcOrClassNode.body.body = scopeInitialization.concat(_funcOrClassNode.body.body);

                (0, _babelTraverse2.default)(t.file(t.program([t.expressionStatement(_funcOrClassNode)])), _visitors.ClosureRefReplacer, null, {
                  residualFunctionBindings: residualFunctionBindings,
                  modified: modified,
                  requireReturns: _this.requireReturns,
                  requireStatistics: requireStatistics,
              ...
              if (_functionValue.$Strict) {
                strictFunctionBodies.push(_funcOrClassNode);
              } else {
                unstrictFunctionBodies.push(_funcOrClassNode);
              }
              (0, _invariant2.default)(_id !== undefined);
              (0, _invariant2.default)(_funcOrClassNode !== undefined);
              defineFunction(_instance2, _id, _funcOrClassNode);
            }
          } catch (err) {
    ...
    key: "_getOrCreateClassNode",
    value: function _getOrCreateClassNode(classPrototype) {
      if (!this.classes.has(classPrototype)) {
        var funcOrClassNode = t.classExpression(null, null, t.classBody([]), []);
        this.classes.set(classPrototype, funcOrClassNode);
        return funcOrClassNode;
      } else {
        var _funcOrClassNode2 = this.classes.get(classPrototype);
        (0, _invariant2.default)(_funcOrClassNode2 && t.isClassExpression(_funcOrClassNode2));
        return _funcOrClassNode2;
      }
    }
  }]);
