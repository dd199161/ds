...
var Serializer = exports.Serializer = function () {
  ...
  _createClass(Serializer, [{
    ...
    value: function init(sources) {
      ...
      try {
        for (var _iterator = additionalFunctionValuesAndEffects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _ref = _step.value;

          var _ref2 = _slicedToArray(_ref, 2);

          var functionValue = _ref2[0];
          var effectsAndTransforms = _ref2[1];

          // Need to do this fixup because otherwise we will skip over this function's
          // generator in the _getTarget scope lookup
          var generator = effectsAndTransforms.effects[1];
